...
public class SpringControllerAdvice {
    ...
    /**
     * Method to handle exception of type RunTimeCustomException thrown from Spring controller
     * @param request HTTP request
     * @param runTimeCustomException run time exception with necessary reason
     * @return Error response with valid error code and message  
     */
    @ExceptionHandler(RunTimeCustomException.class)
    public final ResponseEntity<ErrorResponse> handleRunTimeException(HttpServletRequest request, 
    		RunTimeCustomException runTimeCustomException) {
        int statusCode = runTimeCustomException.getStatusCode();
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setStatus(statusCode);
